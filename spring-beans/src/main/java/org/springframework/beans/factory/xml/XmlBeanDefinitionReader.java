...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	public XmlBeanDefinitionReader(BeanDefinitionRegistry registry) {
		super(registry);/*这里可以理解为XmlBeanDefinitionReader就是bean的容器*/
	}
	...
	protected int doLoadBeanDefinitions(InputSource inputSource, Resource resource)
			throws BeanDefinitionStoreException {
		try {
			//得到解析文档:确定解析模式是DTD还是XSD，确定EntityResolver-->ResourceEntityResolver
			Document doc = doLoadDocument(inputSource, resource);
			//开始根据Resource和doc来注册bean
	...
	protected Document doLoadDocument(InputSource inputSource, Resource resource) throws Exception {
		return this.documentLoader.loadDocument(inputSource, getEntityResolver()/*得到EntityResolver，该类的作用是决定去哪里寻找DTD与XSD*/, this.errorHandler,
				getValidationModeForResource(resource)/*加载文档的验证模式//TODO:探寻过程*/, isNamespaceAware());
	}
	...
	public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
		...
		//委派给BeanDefinitionDocumentReader来把doc转换成BeanDefinition

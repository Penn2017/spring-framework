...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	...
	/**
	 * XmlBeanFactory 间接实现了AliasRegistry和BeanDefinitionRegistry，因此，这里先不管XmlBeanFactory还实现
	 * 了什么其他的接口，只需要知道，XmlBeanFactory可以调用AliasRegistry和BeanDefinitionRegistry里面的
	 * 接口方法即可
	 */

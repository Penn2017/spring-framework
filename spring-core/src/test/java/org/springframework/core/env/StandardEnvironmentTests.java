...
public class StandardEnvironmentTests {
	...
	public void merge() {
		...
		child.getPropertySources().addLast(
				new MockPropertySource/*PropertiesProptySouce*/("childMock")
	...
	public void propertySourceOrder() {
		...
		MutablePropertySources/*持有一个List的PropertySource*/ sources = env.getPropertySources();
		System.out.println("------------>"+sources.get("systemProperties"));
		System.out.println("------------>"+sources.get("systemEnvironment"));
		/**
		 * 处于第0个位置
		 */
